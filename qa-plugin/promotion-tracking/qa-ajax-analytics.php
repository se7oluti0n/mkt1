...
function init_paging(){
	...
	$analytics_template->set_data('tracking-analytics', '{STATUS_VAL}', 
										array( 'selected' => 1,
												'options' => array( 1 => 'Status 1', 
																	2 => 'Status 2', 
																	3 => 'Status 3'))
										);	
	$analytics_template->set_data('tracking-analytics', '{SALE_METHOD_VAL}', 
										array( 'selected' => 1,
	...
	$analytics_template->set_data('tracking-analytics', '{PROMOTION_LIST_VAL}', $promotion_list_html);
	...
	$analytics_template->set_data('tracking-analytics', '{KEYWORD}', 'KEYWORD');
	$analytics_template->set_data('tracking-analytics', '{SALE_METHOD}', 'SALE METHOD');
	$analytics_template->set_data('tracking-analytics', '{RANKING}', 'RANKING');
	$analytics_template->set_data('tracking-analytics', '{SEARCH}', 'SEARCH');
